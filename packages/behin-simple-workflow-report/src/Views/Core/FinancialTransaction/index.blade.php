...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            افزودن بدهکاری: یعنی مشتری به مدار پرداز بدهکار است. مانند مشتری از مجله لیزر خدماتی دریافت کرده یا کالایی از مدار پرداز خریده یا مجله لیزر مبلغی به مشتری پرداخت کرده است.
        </div>
    </div>
    <div class="card mb-3">
        <div class="card-header">
    ...
    <div class="card table-responsive">
        ...
        <div class="card-body">
            ...
            بدهکاری واقعی
            (مبلغی که مجله لیزر از طرف حساب های خود طلب دارد):
            : {{ number_format($totalDebit) }} <br>
            بستانکاری واقعی
            (مبلغی که مجله لیزر به طرف حساب های خود بدهکار است):
