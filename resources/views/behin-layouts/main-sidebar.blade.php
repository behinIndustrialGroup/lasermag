<aside class="main-sidebar elevation-4" style="background: #263238; color: #fff; min-height: 100vh;">
    ...
    <div class="sidebar p-3" style="direction: ltr;">
        <div style="direction: rtl;">
            <div class="user-panel d-flex align-items-center mb-4 p-2 rounded"
                style="background: rgba(255,255,255,0.05);">
                <div class="">
                    <img src="{{ url('behin/behin-dist/dist/img/avatar5.png') }}" class="rounded-circle" alt="User Image"
                        width="45" height="45">
                </div>
                <div class="info">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    @foreach (config('sidebar.menu') as $menu)
                        @if (access('منو >>' . $menu['fa_name']))
                            @if (isset($menu['route-name']) and Route::has($menu['route-name']))
                                <li class="nav-item">
